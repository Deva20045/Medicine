...
> `REAUDIT_CH7_SOURCE_ORDER.md`; Ch 8 found 0 wrong keys — see `REAUDIT_CH8_SOURCE_ORDER.md`; Ch 9 found 1 wrong key — see `REAUDIT_CH9_SOURCE_ORDER.md`; Ch 10 found 0 wrong keys — see `REAUDIT_CH10_SOURCE_ORDER.md`); next is Ch 11, p762.
